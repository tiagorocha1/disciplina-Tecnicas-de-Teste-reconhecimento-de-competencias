    ...
    const renderRows = () => {
        ...
        return list.map(task => (
            <tr key={task.id} className='focus-in-expand-fwd'>                             
                ...
                <td className={task.done ? 'markedAsDone col-lg-7 col-md-6 col-sm-5 col-xs-6 taskLine' : 'col-lg-7 col-md-6 col-sm-5 col-xs-6 taskLine notMarkedAsDone'} >{task.description}</td>            
